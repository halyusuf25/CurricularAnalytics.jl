...
mutable struct CourseRecord
    ...
    repeat_code::AbstractString         # a code the explain the reason for retaking this course

    # Constructor
    function CourseRecord(course::Course, grade::Grade, term::AbstractString="", 
                            earn_credit::Bool=true, repeat_code::AbstractString="-",grading_basis::AbstractString="GRD")
        this = new()
        this.course = course
        this.grade = grade
        this.term = term
